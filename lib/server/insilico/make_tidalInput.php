 ...
 * 
 * This file runs R script that creates TiDAL input file of the dataset passed
 */
...
$myFile = "inSilicoDB" . DIRECTORY_SEPARATOR . "makeTidalInputSettings.txt";
try {
  $fh1 = fopen($myFile, 'w');
  fwrite($fh1, $params1);
} catch (Exception $e) {
...
$pathToRScript = "inSilicoDB" . DIRECTORY_SEPARATOR . "makeTidalInput.R";
