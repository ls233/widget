 ...
 * 
 * This file runs R script that generates RNA-seq data heatmap
 */
...
$myFile = "inSilicoDB" . DIRECTORY_SEPARATOR . "heatmapSettings_cuffDif.txt";
try {
  $fh1 = fopen($myFile, 'w');
  fwrite($fh1, $params1);
} catch (Exception $e) {
...
$pathToRScript = "inSilicoDB" . DIRECTORY_SEPARATOR . "makeHeatmap_cuffDif.R";
